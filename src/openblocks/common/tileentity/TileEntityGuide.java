...
/**
 * Entidad que representa el bloque Gu�a 
 * @author OpenBlocks
 *
 */
public class TileEntityGuide extends SyncedTileEntity implements IShapeable, IShapeProvider, IActivateAwareTile {
	...
	/**
	 * M�todo que devuelve la GuideShape que representa el modo actual
	...
	/**
	 * M�todo que recrea la figura fantasma
	 */
	...
	/**
	 * M�todo que retorna la figura fantasma actual
	...
	/**
	 * M�todo que retorna la figura previa
	...
	/**
	 * M�todo que cambia de modo, es decir, de GuideShape
	 * @param player El jugador que efectu� el cambio
	 */
	...
	/**
	 * M�todo que itera sobre los distintos paramentros del GuideShape, cambiando de modo y recreando la figura 
	 */
	...
	/**
	 * M�todo que cambia las dimensiones de la figura fantasma
	 * @param player El jugador que efectu� el cambio
	 * @param orientation Lado del bloque que se seleccion�
	 */
	...
	/**
	 * M�todo que cambia las dimensiones de la figura fantasma seg�n la orientaci�n seleccionada
	 * @param orientation Lado del bloque que se seleccion�
	 */
	...
	/**
	 * M�todo que rellena la figura fantasma con el tipo de bloque que tiene el jugador en la mano
	 * @param player El jugador que efectu� el cambio
	 */
