...
public class OurEntityRegistry {
    ...
    private static final OurEntityRegistry INSTANCE = new OurEntityRegistry();
    ...
    public static OurEntityRegistry instance()
    {
        return INSTANCE;
    }

    private OurEntityRegistry()
    {
    ...
    public static void registerGlobalEntityID(Class <? extends Entity > entityClass, String entityName, int id)
    {
        ...
        OurEntityList.addMapping(entityClass, entityName, id);
    }
    ...
    public static void registerGlobalEntityID(Class <? extends Entity > entityClass, String entityName, int id, int backgroundEggColour, int foregroundEggColour)
    {
        ...
        OurEntityList.addMapping(entityClass, entityName, id, backgroundEggColour, foregroundEggColour);
    }
